...
enum GameObject {
    ...
    struct Key {
        let collectibleSettings = Collectible(type: .key, collectSound: "key", destroySound: "destroyed")
    }

    struct Food {
        let collectibleSettings = Collectible(type: .food, collectSound: "food", destroySound: "destroyed", canDestroy: true)
    }

    struct Treasure {
        let collectibleSettings = Collectible(type: .treasure, collectSound: "treasure", destroySound: "destroyed")
    }
